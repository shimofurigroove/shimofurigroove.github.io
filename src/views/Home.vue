		...
		<div class="container">
				...
				<ul class="date-list">
					<li>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<p>
									霜降りGROOVE at 米沢市金熊食堂！！！<br />
									クリスマスをDJイベントで楽しみましょう！一人でもお気軽にお越しくださいませ！
								</p>
			...
			<section id="archive">
				...
				<ul class="img-gallery">
					...
					<li>
						<router-link to="/2021-08-22">
							<img src="/images/17/flyer.jpg" />
						</router-link>
					</li>
					<li>
					...
					<li>
						<router-link to="/2021-02-20">
							<img src="/images/11/flyer.png" />
						</router-link>
					</li>
					<li>
			...
			<section id="sns">
				...
				<div class="btn-wrap">
					<p class="text-center">
						<a class="btn btn-primary" href="https://www.instagram.com/shimofurigroove/" target="_blank" role="button">Instagram</a>
					</p>
					<p class="text-center">
