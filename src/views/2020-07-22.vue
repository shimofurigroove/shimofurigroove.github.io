		...
		<div class="container">
			<section>
				<div class="page-header" id="banner">
					<div class="my-4">
						<h1><span class="emoji">🍖</span>米沢のDJイベント、霜降りGROOVE episode #3</h1>
						<p>ご参加くださいましたみなさんありがとうございました！B'zで大盛りあがりな一夜でした笑。</p>
					</div>
					<ul class="img-gallery">
						<li><img src="/images/03/01.jpg" /></li>
					</ul>
				</div>
				<div class="row">
					<div class="col-md-6">
						<p>
							<a href="/images/03/flyer.jpg" target="_blank"><img src="/images/03/flyer.jpg"/></a>
						</p>
					</div>
					<div class="col-md-6">
						<p>
...
export default {
	name: "Home",
	metaInfo: {
		title: "山形県米沢市のDJイベント、霜降りGROOVE episode #3 | Shimofuri Groove, DJ event based in Yonezawa Yamagata",
		meta: [
			{
				name: "description",
			...
			{
				property: "og:title",
				content: "山形県米沢市のDJイベント、霜降りGROOVE episode #3 | Shimofuri Groove, DJ event based in Yonezawa Yamagata",
			},
			{
