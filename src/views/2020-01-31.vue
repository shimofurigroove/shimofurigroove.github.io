        ...
        <section>
            <div class="page-header" id="banner">
                ...
                <ul class="img-gallery">
                    <li><img src="/images/02/05.jpg"><br>Jpopでつないでみよう！</li>
                    <li><img src="/images/02/01.jpg"><br>店員さんもDJ体験。</li>
                    <li><img src="/images/02/04.jpg"><br>Launch Pad Mini MK3でフィンガードラム。</li>
                    <li><img src="/images/02/02.jpg"><br>フリーDJにご参加くださった皆様ありがとうございます！</li>
                    <li><img src="/images/02/03.jpg"><br>いろんなジャンルの音楽を聞くことができました。</li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <p><a href="/images/02/flyer.png" target="_blank"><img src="/images/02/flyer.png"></a></p>
                </div>
                <div class="col-md-6">
                    <p>
                        米沢のDJイベントが増えてほしい、という思いでDJに興味がある方に向けてDJ体験会を開催します！<br>
                        Open DJの時間では、レコード、PC、コントローラーなどお持ちの方は自由にDJしてOKです。<br>
...
export default {
  name: 'Home',
  metaInfo: {
    title: '山形県米沢市のDJイベント、霜降りGROOVE episode #2 | Shimofuri Groove, DJ event based in Yonezawa Yamagata',
    meta: [
      {
        name: "description",
      ...
      {
        property: "og:title",
        content: "山形県米沢市のDJイベント、霜降りGROOVE episode #2 | Shimofuri Groove, DJ event based in Yonezawa Yamagata"
      },
      {
