...
const routes = [
	...
	{
		path: "/2021-12-18",
		name: "山形県米沢市のDJイベント、霜降りGROOVE episode #21 | Shimofuri Groove, DJ event based in Yonezawa Yamagata",
		component: () => import("../views/2021-12-18.vue"),
	},
	{
		path: "/2021-12-25",
		name: "山形県米沢市のDJイベント、霜降りGROOVE episode #22 | Shimofuri Groove, DJ event based in Yonezawa Yamagata",
		component: () => import("../views/2021-12-25.vue"),
	},
	{
		path: "/2022-01-28",
		name: "山形県米沢市のDJイベント、霜降りGROOVE episode #23 | Shimofuri Groove, DJ event based in Yonezawa Yamagata",
		component: () => import("../views/2022-01-28.vue"),
	},
	{
		path: "/2022-03-26",
		name: "山形県米沢市のDJイベント、霜降りGROOVE episode #24 | Shimofuri Groove, DJ event based in Yonezawa Yamagata",
		component: () => import("../views/2022-03-26.vue"),
	},
];
